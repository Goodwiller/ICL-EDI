//g++ -L/usr/include/botan-2/lib -I/usr/include/botan-2/include/botan-2/ -Wl,-rpath=/usr/include/botan-2/lib/ -Wall -o es1 edge_server_1.cpp -lbotan-2
//./es1
...
void listen1(int sockfd) {
    ...
    while(1) {
        ...
        if ( m.type == 1) {
        	recv_file(m, sockfd, service_vendor_addr);
        } else {
